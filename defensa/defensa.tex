...
\begin{frame}{Qué vimos}
    ...
    \pause
    \item Benchmark y resultados versus la versión anterior, no se perdió eficiencia.
    \end{itemize}

    \begin{block}{}
    La idea de exploración on-the-fly, y gran parte de la estructura del algoritmo, se puede aplicar a otro tipo de problemas (además de non-blocking), ej: GR1 (próximamente).
    \end{block}
\end{frame}
%-------------------------------------------------------
\begin{frame}{Preguntas}
    Gracias, vuelvan prontos [img de apu]
\end{frame}
%-------------------------------------------------------
\end{document}
