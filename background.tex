...
Algorithm classicalSolver($E, A_E^C$):
	...
	while $C' \neq  C:$
		...
		$H_0 = \emptyset$
		for $i=0,1..$ until $H' = H$:
			$H_{j+1}=$playerCanForce(E,$H_j$)$\cup(M_E \cap$playerCanForce(E,C)$)$
		$C=H_j$
	return C
